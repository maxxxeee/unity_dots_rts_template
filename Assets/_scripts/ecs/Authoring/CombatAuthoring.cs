...
// this combat authoring is meant to be used with an entity spawner as it used for benchmark purposes
...
public class CombatAuthoring_Baker : Baker<CombatAuthoring>
{
